...
public class PiccolorColoritemsbyspecid {
    public static void main(String[] args) {
        SpringApplication.run(PiccolorColoritemsbyspecid.class, args);
        String od = "http://car.api.autohome.com.cn";
        String nd = "http://car-car-api-http.thallo.corpautohome.com";
        for (int i = 0; i <= 63265; i++) {
            String url = "/v1/carpic/piccolor_coloritemsbyspecid.ashx?_appid=app&specid=" + i;
