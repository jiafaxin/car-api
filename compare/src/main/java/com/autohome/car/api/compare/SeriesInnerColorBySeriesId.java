...
public class SeriesInnerColorBySeriesId {
    public static void main(String[] args) {
        SpringApplication.run(SeriesInnerColorBySeriesId.class, args);
        ...
        for (int i = 0; i <= 7300; i++) {
            String url = "/v1/carprice/series_innercolorbyseriesid.ashx?_appid=app&seriesid="+i;
