...
@Component
public class SpecPicColorStatisticsBaseService extends BaseService<List<SpecPicColorStatisticsEntity>> {
    ...
    List<SpecPicColorStatisticsEntity> getData(int seriesid) {
        List<SpecPicColorStatisticsEntity> list = carSpecPicColorStatisticsMapper.GetSpecPicColorStatisticsBySeriesId(seriesid);
        return list;
    }
