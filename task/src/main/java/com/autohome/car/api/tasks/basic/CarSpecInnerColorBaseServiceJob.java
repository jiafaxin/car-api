...
@JobHander(value = "CarSpecInnerColorBaseServiceJob")
@Service
public class CarSpecInnerColorBaseServiceJob extends IJobHandler {

    @Autowired
    CarSpecInnerColorBaseService baseService;
