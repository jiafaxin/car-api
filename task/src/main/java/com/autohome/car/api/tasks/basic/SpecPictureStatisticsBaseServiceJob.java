...
@JobHander(value = "SpecPictureStatisticsBaseServiceJob")
@Service
public class SpecPictureStatisticsBaseServiceJob extends IJobHandler {

    @Autowired
    SpecPictureStatisticsBaseService baseService;
